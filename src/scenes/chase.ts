...
export function makeChase(): GameScene {
  ...
  scene.fog = new THREE.Fog(0x050505, 3, 21)
  ...
  scene.add(new THREE.HemisphereLight(0x665555, 0x0a0a0a, 0.5))
  const red1 = new THREE.PointLight(0xff2211, 10, 9)
  red1.position.set(-0.8, 2.3, -4)
  scene.add(red1)
  const red2 = new THREE.PointLight(0xff2211, 10, 9)
  red2.position.set(-0.8, 2.3, -20)
  scene.add(red2)
  const exitLight = new THREE.PointLight(0x22cc66, 5, 7)

...
export function makeChase(): GameScene {
  ...
  scene.add(new THREE.HemisphereLight(0x776666, 0x141010, 0.75))
  const red1 = new THREE.PointLight(0xff2211, 14, 12)
  red1.position.set(-0.8, 2.3, -4)
  scene.add(red1)
  const red2 = new THREE.PointLight(0xff2211, 14, 12)
  red2.position.set(-0.8, 2.3, -20)
  scene.add(red2)
  const exitLight = new THREE.PointLight(0x22cc66, 6, 8)
